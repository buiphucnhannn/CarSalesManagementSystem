...
public interface StatisticsDao {
     ...
     * Có thể lọc theo chi nhánh hoặc tính trên toàn hệ thống.
     * @param fromInclusive Thời điểm bắt đầu (bao gồm).
     * @param toExclusive Thời điểm kết thúc (không bao gồm).
     * @param branchId ID của chi nhánh để lọc. Nếu null, tính trên toàn hệ thống.
     * @return Tổng doanh thu.
     */
    BigDecimal sumRevenue(LocalDateTime fromInclusive, LocalDateTime toExclusive, Long branchId);
     ...
     * @param branchId ID của chi nhánh để lọc. Nếu null, đếm trên toàn hệ thống.
     * @return Tổng số lượng đơn hàng.
     */
    long countOrders(LocalDateTime fromInclusive, LocalDateTime toExclusive, Long branchId);
     ...
     */
    long countPaidOrders(LocalDateTime fromInclusive, LocalDateTime toExclusive, Long branchId);

    /**
     * Lấy dữ liệu doanh thu hàng ngày trong một khoảng thời gian để vẽ biểu đồ xu hướng.
     * @param fromInclusive Thời điểm bắt đầu.
     * @param toExclusive Thời điểm kết thúc.
     * @param branchId ID của chi nhánh để lọc. Nếu null, lấy trên toàn hệ thống.
     * @return Danh sách các mảng Object, mỗi mảng chứa [ngày, tổng doanh thu ngày đó].
     */
    List<Object[]> findDailyRevenue(LocalDateTime fromInclusive, LocalDateTime toExclusive, Long branchId);
     ...
     */
    List<Object[]> findDailyOrders(LocalDateTime fromInclusive, LocalDateTime toExclusive, Long branchId);
     ...
     */
    List<Object[]> findOrderStatusBreakdown(LocalDateTime fromInclusive, LocalDateTime toExclusive, Long branchId);
     ...
     */
    List<Object[]> findPaymentMethodBreakdown(LocalDateTime fromInclusive, LocalDateTime toExclusive, Long branchId);
     ...
     */
    List<Object[]> findTopCars(LocalDateTime fromInclusive, LocalDateTime toExclusive, Long branchId, int limit);
